function [tkeo, tkeo_envelope, onset_indexes, baseline_th] = getFeatures(signal, filter_order, cutoff_low, cutoff_high, sampling, tkeo_window_size, alpha, no_onset_period_ms, vibration_time_ms, vibration_flag)
    % This function extracts features from given signal signal.
    % Inputs:
    ...
    if ~vibration_flag
        ...
        onset_indexes = getSignalOnset(tkeo_envelope, baseline_th, no_onset_period_ms, vibration_flag, vibration_time_ms);
    end
end